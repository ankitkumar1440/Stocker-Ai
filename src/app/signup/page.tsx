      ...
      <div className="glass-panel p-8 md:p-12 rounded-3xl w-full max-w-md relative z-10 border border-outline-variant/30 shadow-[0_0_40px_rgba(0,0,0,0.2)]">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input type="text" required value={name} onChange={e => setName(e.target.value)} className="w-full bg-surface-highest/50 border border-outline-variant/30 rounded-xl px-4 py-3 text-on-surface focus:outline-none focus:border-secondary transition-all focus:bg-surface-highest" placeholder="Full Name" />
          </div>
          <div>
